...
@onready var gravestone = preload("res://gravestone.tscn")
@onready var attack_timer: Timer = $AttackTimer
@onready var orb = preload("res://light_orb.tscn")
...
var target: Node2D = null# Called when the node enters the scene tree for the first time.
func _ready() -> void:
	target = hero
