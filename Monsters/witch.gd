...
var damage: int = 5
var spider_spawner = [$SpiderSpawner1, $SpiderSpawner2, $SpiderSpawner3, $SpiderSpawner4, $SpiderSpawner5]
...
func _on_area_2d_body_entered(body:Node2D) -> void:
	target = body
	var spawn1 = spawner.instantiate()
	spawn1.position = $SpiderSpawner1.position
